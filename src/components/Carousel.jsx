...
function CarouselPage({ className = "" }) {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-16 gap-x-8 justify-items-center min-h-[160px] transition duration-300 hover:cursor-pointer ${
